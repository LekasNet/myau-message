...
abstract class AppTextStyle {
  ...
  static final title = _headline.copyWith(fontSize: 24, height: 1.3);

  static final titleM =
  _inter.copyWith(fontSize: 20, fontWeight: FontWeight.w600);
  static final titleS =
  _inter.copyWith(fontSize: 20, fontWeight: FontWeight.w600);
  ...
  static final tab = _inter.copyWith(fontSize: 20, fontWeight: FontWeight.w600);
  static final bodyL =
  ...
  _inter.copyWith(fontSize: 20, fontWeight: FontWeight.w500);
  static final captionS =
  _inter.copyWith(fontSize: 20, fontWeight: FontWeight.w500);
  static final chip = _inter.copyWith(
      fontSize: 20, fontWeight: FontWeight.w700, letterSpacing: 0.50);
}